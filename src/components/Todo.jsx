...
function Todo({name, completed, id, toggleTaskCompleted, handleDelete, handleEdit}){
    ...
    const editingTemplate = (
        <form className="stack-small" onSubmit={handleSubmit}>
            ...
            <button type="button" className="btn todo-cancel" onClick={() => setIsEditing(!isEditing)}>
                Cancel
